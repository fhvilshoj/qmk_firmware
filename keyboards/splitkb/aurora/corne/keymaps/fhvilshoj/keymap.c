...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[BL] = LAYOUT_split_3x6_3(
	        KC_TAB, KC_Q, RCTL_T(KC_W), RALT_T(KC_E), KC_R, KC_T,                                   KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC,
	        ...
	        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B,                                  KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RALT,
	                             KC_LGUI, MO(CH), MT(MOD_LCTL, KC_ENT),      MT(MOD_LSFT, KC_SPC), MO(NUM), MT(MOD_HYPR, KC_LALT)
	      ),
